...
namespace qlthucung.Controllers
{
    public class CartController : Controller
    {
        ...
        public IActionResult Index([Bind("Hoten,Tendangnhap,Matkhau,Email,Diachi,Dienthoai,Ngaysinh,RoleId,Status,Resetpasswordcode")] KhachHang kh, DonHang dh, ChiTietDonHang ctdh, IFormCollection form)
        {
            kh.Hoten = form["hoten"];
            ...
            kh.Dienthoai = form["sdt"];
            kh.Ngaysinh = DateTime.Parse(form["ngaysinh"]);
            kh.RoleId = 2;
            kh.Status = 1;
